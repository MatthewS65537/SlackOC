...
1. Install (Node ≥ 20): `curl -fsSL https://raw.githubusercontent.com/matthewsu/SlackOC/main/install.sh | bash` — and have `opencode` ≥ 1.18 on your box. *(npm: `npm i -g slackoc` — coming soon.)*
